...
const getInitialStructure = (): Tower[] => {
  const saved = localStorage.getItem('entrega_propi_mad_custom_structure');
  if (saved) {
    try {
...
const DATA_CACHE_KEY = 'entrega_propi_mad_cache_v2';
const TIMELINE_EVENTS_KEY = 'entrega_propi_mad_timeline_events_v1';
...
const writeCustomStructure = (towers: Tower[]) => {
  try {
    localStorage.setItem('entrega_propi_mad_custom_structure', JSON.stringify(towers));
  } catch {}
};
