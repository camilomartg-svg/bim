...
export default function App() {
  ...
  const [noraLogoOk, setNoraLogoOk] = useState(true);
  const [GreenILogoOk, setGreenILogoOk] = useState(true);
      ...
      <header className="min-h-16 flex flex-col sm:flex-row sm:items-center sm:justify-between px-3 sm:px-8 py-2 sm:py-0 gap-2 border-b border-slate-200 bg-white">
        <div className="w-full sm:w-auto flex items-center justify-between sm:justify-start gap-4">
          <div className="flex items-center gap-2">
            ...
            <a href="../home.html" className="flex items-center" title="Ir al Home">
              {noraLogoOk ? (
                <img
                  src="https://i.postimg.cc/RVp8pZwc/LOGO-NORA-NEGRO.png"
                  alt="nora CDE"
                  className="h-7 sm:h-10 w-auto object-contain"
                  loading="eager"
                  decoding="async"
                  referrerPolicy="no-referrer"
                  onError={() => setNoraLogoOk(false)}
                />
              ) : (
                <div className="text-[11px] font-black tracking-widest text-slate-700">NORA</div>
              )}
            </a>
          </div>
          {GreenILogoOk ? (
            <img
              src="https://i.postimg.cc/Hsrt7fXx/LOGO-GreenI.jpg"
              alt="Green I"
              className="h-7 sm:hidden w-auto object-contain"
              loading="eager"
              decoding="async"
              referrerPolicy="no-referrer"
              onError={() => setGreenILogoOk(false)}
            />
          ) : (
            <div className="text-[11px] font-black tracking-widest text-slate-700 sm:hidden">Green I</div>
          )}
        </div>
        ...
        <div className="hidden sm:flex items-center gap-4">
          {GreenILogoOk ? (
            ...
            <div className="text-xs font-black tracking-widest text-slate-700">Green I</div>
          )}
        </div>
      </header>
