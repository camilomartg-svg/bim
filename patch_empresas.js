...
const newScript = `<script>
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            try {
                ...
                const res = await fetch(url + '?action=getCompanies');
            ...
            if (companies.length === 0) {
                list.innerHTML = \`
                    <div class="flex flex-col items-center justify-center w-full h-full text-center p-12 mx-auto" style="width: 100%; grid-column: 1 / -1;">
                        ...
                        <p class="text-sm text-gray-500 max-w-sm">Tu cuenta fue creada exitosamente, pero aún no has sido invitado a ninguna empresa o proyecto. Por favor contacta al administrador.</p>
                    </div>
                \`;
            } else {
                // --- Renderizar tarjetas ---
...
console.log('Fixed empresas.html script block');
