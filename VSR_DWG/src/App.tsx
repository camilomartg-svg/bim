        ...
        <header className="h-12 bg-white dark:bg-black border-b border-slate-200 dark:border-slate-800 px-4 flex items-center justify-between z-30 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              {isDarkMode ? (
                 <img src="https://i.postimg.cc/0yDgcyBp/Logo-transparente_blanco.png" alt="Nora" className="h-6 object-contain opacity-90" />
              ) : (
                 <img src="https://i.postimg.cc/GmWLmfZZ/Logo-transparente_negro.png" alt="Nora" className="h-6 object-contain opacity-90" />
              )}
            </div>
