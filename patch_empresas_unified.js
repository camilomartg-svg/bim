...
// Eliminar el primer script de background validation si existe
const script1Regex = /<script>\s*\/\/\s*Background validation with Single Source of Truth[\s\S]*?<\/script>/;
html = html.replace(script1Regex, '');

// Reescribir el segundo script para hacer TODO de forma sincrona
...
console.log('Fixed empresas.html with unified logic');
