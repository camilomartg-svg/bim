...
function enforceAuthenticatedAccess() {
    ...
    overlay.style.background = 'radial-gradient(circle at top, rgba(23, 23, 23, 0.22), rgba(23, 23, 23, 0) 30%), linear-gradient(135deg, rgba(255,255,255,0.96), rgba(245,245,245,0.96))';
    overlay.innerHTML = `
        <div style="width:min(520px, 100%); background:#ffffff; border:1px solid rgba(23, 23, 23, 0.14); border-radius:24px; padding:36px 32px; box-shadow:0 30px 80px rgba(96, 94, 98, 0.18); text-align:center; font-family:Inter, Arial, sans-serif;">
            ...
            <a href="${LOGIN_URL}" style="display:inline-flex; align-items:center; justify-content:center; gap:10px; min-width:220px; padding:14px 18px; border-radius:12px; background:#171717; color:#fff; text-decoration:none; font-weight:700; font-size:15px; box-shadow:0 12px 28px rgba(23, 23, 23, 0.28);">
