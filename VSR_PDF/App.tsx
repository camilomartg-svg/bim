...
const App: React.FC = () => {
  ...
  useEffect(() => {
    console.log(`%c NORA BIM v2.4 - ${new Date().toLocaleTimeString()} `, "background: #171717; color: #fff; font-size: 20px; padding: 10px;");
  }, []);
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full relative">
        ...
        {file && (
          ...
          >
            ...
            {calibration ? (
              <div className="flex items-center gap-2 text-[#171717] text-[10px] font-black animate-pulse">
                        ...
                        <button
                          ...
                          className={`w-full text-left px-3 py-2 rounded-lg text-[11px] font-medium transition border ${
                            file && file.name.startsWith(drawing.name)
                              ? (
                                  theme === 'dark'
                                    ? 'bg-[#171717]/15 border-[#171717]/40 text-white'
                                    : 'bg-[#171717]/10 border-[#171717] text-[#000000]'
                                )
                              : (
                                  theme === 'dark'
                                    ? 'bg-[#15121A] hover:bg-[#211C2A] text-[#C5C0C8] border-transparent'
            ...
            {isLoadingDrawing && (
              <div className="absolute inset-0 bg-[#000000]/70 flex items-center justify-center z-40">
                <div className="px-4 py-3 rounded-xl bg-[#0B0B0F] border border-[#605E62]/60 shadow-2xl flex items-center gap-3">
                  <div className="w-6 h-6 border-2 border-[#171717]/20 border-t-[#171717] rounded-full animate-spin" />
