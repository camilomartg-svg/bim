    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center viewer-panel m-8 rounded-3xl">
        <div className="text-center space-y-4 max-w-sm p-8">
          <div className="w-20 h-20 bg-[#171717]/10 rounded-full flex items-center justify-center mx-auto mb-6 border border-[#171717]/20">
            <i className="fa-solid fa-layer-group text-3xl text-[#171717]"></i>
          </div>
      ...
      <div className="relative w-fit min-w-full min-h-full flex p-20">
        ...
        >
          ...
          <svg className="absolute inset-0 pointer-events-none w-full h-full">
            {points.map((p, i) => (
              <circle key={i} cx={p.x} cy={p.y} r="6" fill="#171717" stroke="#000" strokeWidth="2" />
            ))}
            {points.length === 2 && (
              <>
                <line x1={points[0].x} y1={points[0].y} x2={points[1].x} y2={points[1].y} stroke="#171717" strokeWidth="3" strokeDasharray="6,4" />
      ...
      {loading && (
        <div className="absolute inset-0 bg-[#000000]/80 backdrop-blur-md flex items-center justify-center z-50">
          <div className="flex flex-col items-center gap-6">
            <div className="w-16 h-16 border-4 border-[#171717]/20 border-t-[#171717] animate-spin rounded-full"></div>
            <div className="text-center">
              <span className="block text-[#171717] font-mono text-xs tracking-widest uppercase mb-1">Cargando Render BIM</span>
