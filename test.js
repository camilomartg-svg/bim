async function test() { const container = document.getElementById('scroll-container');
                ...
                if (userAccount) {
                    ...
                    if (userAccount.role === 'SUPER_ADMINISTRADOR') {
                        ...
                        companies = uniqueCompanies.map(c => ({
                            ...
                            image: c.logoBase64 || 'https://i.postimg.cc/t4mFvCyb/default-company.jpg',
                        ...
                        if (myComp) {
                            companies.push({
                                ...
                                image: myComp.logoBase64 || 'https://i.postimg.cc/t4mFvCyb/default-company.jpg',
                            ...
                            companies.push({
                                ...
                                location: 'Pendiente',
                                image: 'https://i.postimg.cc/t4mFvCyb/default-company.jpg',
                                code: 'NEW',
            ...
            if (companies.length === 0) {
                ...
                list.innerHTML = companies.map(c => `
                    <a href="home.html?empresa=${c.id}" class="card-hover flex-none w-full group transition-transform duration-500 block">
